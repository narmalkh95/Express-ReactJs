    ...
    try {
        ...
        for (let m = moment(startDate); m.isBefore(endDate); m.add(1, 'days')) {
            ...
            for (const id of Object.keys(studentsData)) {
                ...
                // Loop through lessons for the current day
                for (const lesson of lessonsForDay) {
                    ...
                    // Push attendance object to attendanceList
                    user.attendanceList.push(attendanceObj);
                }

                // Save user after updating attendanceList for all lessons on the current day
                await user.save();
            }
        }
